...
from trafficclient import service_catalog
...
class HTTPClient(httplib2.Http):
    ...
    USER_AGENT = 'python-trafficclient'
    ...
    def authenticate(self):
        if has_keyring:
            ...
            if not self.no_cache and not self.used_keyring:
                ...
                # was rejected.
                try:
                    block = keyring.get_password("trafficclient_auth",
                                                 keyring_key)
                    if block:
        ...
        if self.version == "v2.0":  # FIXME(chris): This should be better.
            ...
            # In some configurations traffic makes redirection to
        ...
        if has_keyring and not self.no_cache:
            try:
                keyring_value = "%s|%s" % (self.auth_token,
                                           self.management_url)
                keyring.set_password("trafficclient_auth",
