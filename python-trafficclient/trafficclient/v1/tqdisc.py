...
class TqdiscManager(base.Manager):
    resource_class = Tqdisc
    ...
    def create(self, **kwargs):
        ...
        return Tqdisc(self, self._format_image_meta_for_user(body['image']))
